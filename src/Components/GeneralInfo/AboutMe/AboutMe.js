    ...
    return (
        <div className= {styles.AboutMe}>
            ...
            <ul>
                ...
                <li><span><LogoFragment2 h={300}/></span>I was and still am very passionate about web development and I have made a firm decision to keep going in this career path beleiving that someday I can benefit from both of my specialities together.</li>
                <li><span><LogoFragment2 h={300}/></span>The first step toward achieving my goal is to have a <strong>permanent job</strong> as a <b>Full-Stack React Web Developer</b>.</li>
