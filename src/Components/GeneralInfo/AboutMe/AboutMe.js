    ...
    return (
        <div className= {styles.AboutMe}>
            ...
            <ul>
                ...
                <li><span><LogoFragment2 h={300}/>
                </span> I have been interested in programming since my high school years and, the fact 
                that I was a mechatronic engineer, I haven't the chance to know about web development until
                I graduated. </li>
                <li><span><LogoFragment2 h={300}/>
                </span>As a self-taught person I had the chance to broaden my horizon by studying web development  
                and also exploring Python and other non-web-only languages. This passion has since lasted and lead 
                to my decision of becoming a web developer.</li>
                <li><span><LogoFragment2 h={300}/>
